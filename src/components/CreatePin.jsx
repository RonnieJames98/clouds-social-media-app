      ...
      <div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
          ...
          <div className="flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420">
            ...
            {!imageAsset ? (
              ...
              <div className="relative h-full">
                <img src={imageAsset?.url} alt="uploadedPic" className="h-full w-full"/>
                <button 
                  type="button"
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          ...
          <input 
            ...
            className="outline-none text-base sm:lg border-b-2 border-gray-200 p-2"
          />
          <input 
            type="text"
            value={destination}
          ...
          <div className="flex flex-col">
            ...
            <div className="flex justify-end items-end mt-5">
              <button
                type="button"
                onClick={savePin}
                className="bg-sky-300 text-white font-bold p-2 rounded-full w-28 outline-none"
              >
                Upload
              </button>
            </div>
